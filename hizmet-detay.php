...
<title><?=$db->VeriOkuTek("hizmetlerimiz", "isim", "url", $_GET["url"]);?> - Dom Yapı Dekorasyon </title>
...
<div class="main_title">
 <h2 class="wow" data-splitting> Dom Yapı <br><span class="color"><?=$db->VeriOkuTek("hizmetlerimiz", "isim", "url", $_GET["url"]);?> </span>   </h2>
</div>
</div>
<div class="bg_img" style=" height: 428px; background: url(upload/<?=$db->VeriOkuTek("hizmetlerimiz", "resim", "url", $_GET["url"]);?>) no-repeat; 
...
<div style=" margin-bottom: 15px;" class="post_date"><span>Dom Yapı</span>  </div>
<h2  style=" margin-bottom: 5px;" class="blog_single_title"><?=$db->VeriOkuTek("hizmetlerimiz", "isim", "url", $_GET["url"]);?></h2>
