...
<meta charset="utf-8"><?php include("favo.php")?><title>Blog - Dom Yapı Dekorasyon </title>
...
<a href="blog-<?=$rows->url;?>.html"> <img class="img-gluid" src="upload/<?=$rows->resim;?>" alt="<?=$rows->isim;?>"> </a>
<a class="light_btn" href="blog-<?=$rows->url;?>.html"><i class="linearicons-plus"></i></a>
</div>
